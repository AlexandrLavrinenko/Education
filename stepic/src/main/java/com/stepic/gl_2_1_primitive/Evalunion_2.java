 ...
 *
 * Ввод-вывод обеспечивает проверяющая система.
 * Вам надо только проанализировать переданное в метод значение и вернуть результат.
